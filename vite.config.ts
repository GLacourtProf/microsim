...
export default defineConfig({
  // Chemin relatif : fonctionne quel que soit le sous-dossier du site
  // (ex. glacourtprof.github.io/micromeasure-sim/), sans rien à ajuster
  // si le nom du dépôt change.
  base: "./",
